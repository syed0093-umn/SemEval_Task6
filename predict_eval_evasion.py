...
using the trained DeBERTa-v3-large evasion model.
"""
...
# --- Model definition (must match train_deberta_large_evasion.py) ---
...
checkpoint = 'deberta_large_evasion_best.pt'
...
output_file = 'prediction_eval_evasion'
...
submission_zip = 'submission_eval_evasion.zip'
with zipfile.ZipFile(submission_zip, 'w', zipfile.ZIP_DEFLATED) as zf:
 zf.write(output_file, arcname='prediction')
print(f"Created: {submission_zip}")
print("Done. Upload submission_eval_evasion.zip to Codabench.")
